        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-10">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
            <p className="text-sm text-blue-900 dark:text-blue-200">
              <strong>Privacy Notice:</strong> Your email and message are submitted through Formspree to respond to your inquiry. Formspree handles email delivery per their privacy policy at https://formspree.io/privacy. View our <Link to="/privacy" className="underline hover:no-underline">Privacy Policy</Link> for more information.
            </p>
          </div>
