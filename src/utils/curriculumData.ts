...
{ id:'chemistry-CH35', title:'Polymerisation', description:'Advanced polymerisation including addition and condensation polymers, biopolymers, and polymer properties.', subject:'Chemistry' , group:'Organic chemistry (A2)', tags:[{ name:'Topic 35', color:'bg-orange-600' }, { name: 'A2', color:'bg-blue-800' }, { name: 'A2', color: 'bg-blue-900'  }]},
{id: 'chemistry-CH36', title: 'Organic synthesis', description:'Advanced organic synthesis including multi-step syntheses, retrosynthesis, and analytical techniques.', subject:'Chemistry' , group:'Organic chemistry (A2)', tags:[{ name:'Topic 36', color:'bg-orange-600' }, { name: 'A2', color: 'bg-blue-900' }, { name: 'A2', color: 'bg-blue-900'  }]},
...
//------------------------------------------------------------(Physics)------------------------------------------------------------ 
        ...
        //------------------------------------------------------------(Biology)------------------------------------------------------------ 
          ...
          { id: 'Biology-Paper5', title: 'Paper 5 (Practical/Structured)', description: 'Practical techniques, data analysis and structured question practice for Paper 5.', subject: 'Biology' , color: 'from-purple-600 to-purple-500 dark:from-purple-700 dark:to-purple-800', group:'A2' },
    ...
    "subject": "Maths",
    "group": 'Pure 1',
    tags: [{ name: '1.1', color: 'bg-orange-600' }]
  },
  {
    "id": "P1-CH2",
    "title": "Functions",
    ...
    "subject": "Maths",
    "group": 'Pure 1',
    tags: [{ name: '1.2', color: 'bg-orange-600' }]
  },
  {
    "id": "P1-CH3",
    ...
    "subject": "Maths",
    "group": 'Pure 1',
    tags: [{ name: '1.3', color: 'bg-orange-600' }]
  },
  {
    "id": "P1-CH4",
    ...
    "subject": "Maths",
    "group": 'Pure 1',
    tags: [{ name: '1.4', color: 'bg-orange-600' }]
  },
  {
    "id": "P1-CH5",
    "title": "Trigonometry",
    ...
    "subject": "Maths",
    "group": 'Pure 1',
    tags: [{ name: '1.5', color: 'bg-orange-600' }]
  },
  {
    "id": "P1-CH6",
    "title": "Series",
    ...
    "subject": "Maths",
    "group": 'Pure 1',
    tags: [{ name: '1.6', color: 'bg-orange-600' }]
  },
  {
    "id": "P1-CH7",
    ...
    "subject": "Maths",
    "group": 'Pure 1',
    tags: [{ name: '1.7', color: 'bg-orange-600' }]
  },
  {
    "id": "P1-CH8",
    "title": "Integration",
    ...
    "subject": "Maths",
    "group": 'Pure 1',
    tags: [{ name: '1.8', color: 'bg-orange-600' }]
  },
  { id: 'P1-revision', title: 'Pure math 1 Revision', description: 'Comprehensive revision of all Pure math 1 topics to prepare for exams.', subject: 'Maths', color: 'from-purple-600 to-purple-500 dark:from-purple-700 dark:to-purple-800', tags: [{ name: 'Revision', color: 'bg-purple-600' }] , group:'Pure 1' },
 




          { id: 'P3-CH1' , title: 'Algebra', description: 'Explore absolute value equations, master polynomial division, understand factor theorem, decompose partial fractions, and expand binomials with rational powers.' , subject: 'Maths' , group:'Pure 3', tags: [{ name: '3.1', color: 'bg-orange-600' }]},
          { id: 'P3-CH2' , title: 'Logarithmic & exponential functions', description: 'Discover inverse functions eˣ and ln x, apply logarithm laws, solve exponential equations, and transform relationships to linear form.', subject: 'Maths' , group:'Pure 3', tags: [{ name: '3.2', color: 'bg-orange-600' }]},
          { id: 'P3-CH3' , title: 'Trigonometry', description: 'Understand secant, cosecant and cotangent, master compound and double angle identities, and learn to express a sin θ + b cos θ in R-form.', subject: 'Maths' , group:'Pure 3', tags: [{ name: '3.3', color: 'bg-orange-600' }]},
          { id: 'P3-CH4' , title: 'Differentiation', description: 'Master product, quotient and chain rules; explore parametric and implicit differentiation; learn to find tangents and normals.', subject: 'Maths' , group:'Pure 3', tags: [{ name: '3.4', color: 'bg-orange-600' }]},
          { id: 'P3-CH5' , title: 'Integration', description: "Practice reverse differentiation, master trigonometric integrals, apply partial fractions, recognise f'(x)/f(x) form, and learn integration by parts with substitution.", subject: 'Maths' , group:'Pure 3', tags: [{ name: '3.5', color: 'bg-orange-600' }]},
          { id: 'P3-CH6' , title: 'Numerical methods', description: 'Discover how to locate roots by sign change, understand iterative formulas xₙ₊₁ = F(xₙ), and solve equations to required accuracy.', subject: 'Maths' , group:'Pure 3', tags: [{ name: '3.6', color: 'bg-orange-600' }]},
          { id: 'P3-CH7' , title: 'Vectors', description: 'Learn vector operations, understand equations of lines, apply scalar product, find angles between lines, and solve geometric problems in 2D and 3D.', subject: 'Maths' , group:'Pure 3', tags: [{ name: '3.7', color: 'bg-orange-600' }]},
          { id: 'P3-CH8' , title: 'Differential equations', description: 'Explore forming differential equations from rate problems, master separating variables, and discover how to find general and particular solutions.', subject: 'Maths' , group:'Pure 3', tags: [{ name: '3.8', color: 'bg-orange-600' }]},
          { id: 'P3-CH9' , title: 'Complex numbers', description: 'Understand Cartesian form, explore modulus and argument, visualise on Argand diagrams, master polar form, find square roots, and discover loci (circles, perpendicular bisectors, half-lines).', subject: 'Maths' , group:'Pure 3', tags: [{ name: '3.9', color: 'bg-orange-600' }] },

   {
    ...
    tags: [{ name: '5.1', color: 'bg-orange-600' }]
  },
  {
    "id": "S1-CH2",
    ...
    "subject": "Maths",
    "group": 'Probability & Statistics 1',
    tags: [{ name: '5.2', color: 'bg-orange-600' }]
  },
  {
    "id": "S1-CH3",
    "title": "Probability",
    ...
    "subject": "Maths",
    "group": 'Probability & Statistics 1',
    tags: [{ name: '5.3', color: 'bg-orange-600' }]
  },
  {
    "id": "S1-CH4",
    ...
    "subject": "Maths",
    "group": 'Probability & Statistics 1',
    tags: [{ name: '5.4', color: 'bg-orange-600' }]
  },
  {
    "id": "S1-CH5",
    ...
    "subject": "Maths",
    "group": 'Probability & Statistics 1',
    tags: [{ name: '5.5', color: 'bg-orange-600' }]
  },
  { id: 'S1-revision', title: 'Probability & Statistics 1 Revision', description: 'Comprehensive revision of Probability & Statistics 1 to prepare for exams.', subject: 'Maths', color: 'from-purple-600 to-purple-500 dark:from-purple-700 dark:to-purple-800', tags: [{ name: 'Revision', color: 'bg-purple-600' }] , group:'Probability & Statistics 1' },
  


          { id: 'S2-CH1' , title: 'The Poisson distribution', description: ' Learn to calculate probabilities using Po(m), understand mean = variance, model random events, and explore approximations to binomial and normal distributions.', subject: 'Maths' , group:'Probability & Statistics 2', tags: [{ name: '6.1', color: 'bg-orange-600' }]},
          { id: 'S2-CH2' , title: 'Linear combinations of random variables', description: 'Discover how to combine random variables, master expectation and variance rules, and understand when sums follow normal or Poisson distributions.', subject: 'Maths' , group:'Probability & Statistics 2', tags: [{ name: '6.2', color: 'bg-orange-600' }]},
          { id: 'S2-CH3' , title: 'Continuous random variables', description: 'Explore probability density functions, learn to calculate probabilities, and find mean, variance, median and percentiles.', subject: 'Maths' , group:'Probability & Statistics 2', tags: [{ name: '6.3', color: 'bg-orange-600' }]},
          { id: 'S2-CH4' , title: 'Sampling and estimation', description: 'Understand samples vs populations, discover the Central Limit Theorem, calculate unbiased estimates, and learn to determine confidence intervals for means and proportions', subject: 'Maths' , group:'Probability & Statistics 2', tags: [{ name: '6.4', color: 'bg-orange-600' }]},
          { id: 'S2-CH5' , title: 'Hypothesis tests', description: 'Master null and alternative hypotheses, conduct tests for binomial, Poisson and normal distributions, understand one/two-tailed tests, and explore Type I and Type II errors.', subject: 'Maths', group:'Probability & Statistics 2', tags: [{ name: '6.5', color: 'bg-orange-600' }] }
