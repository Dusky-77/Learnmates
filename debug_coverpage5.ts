...
const subtopic1 = mainTopic.subtopics[0];
const subtopic2 = mainTopic.subtopics[1];

const topics = new Set([
  `igcse||cambridge||physics||${unit.unit}||${mainTopic.topic}`,
  `igcse||cambridge||physics||${unit.unit}||${subtopic1.subtopic}`,
  `igcse||cambridge||physics||${unit.unit}||${subtopic2.subtopic}`,
]);
